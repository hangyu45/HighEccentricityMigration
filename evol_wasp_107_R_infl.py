...
"""
    Source code for evolving one system under high-e migration. 
    Allowing planetary radius inflation.
...
def evol_one(idx, 
    ...
    dlogR2_adj = kwargs.pop('dlogR2_adj', 1.)   # adjustment of Millholland formula
    
    
    print(idx,'\n', 'ai_0:', ai_0/AU, 'R2_0', R2_0/Rj, 'M2_0:', M2_0/Mj, 'M3:', M3/Mj)
    print('I_io_0:', I_io_0*180./np.pi, 'eo_0:', eo_0, 'phi_eo_0:', phi_eo_0, 
          'AAA:', AAA, 'tau_r_Myr:', tau_r_Myr, 'dlogR2_adj:', dlogR2_adj)        
    ...
    tau_d = tau_d_Myr * P_yr * 1e6
    tau_r = tau_r_Myr * P_yr * 1e6
    ...
    no_mig_event = lambda t_nat_, y_nat_vect_:\
                    LK.no_mig(t_nat_, y_nat_vect_, par_LK, ai_0, 
                              dlogai_th=0.05, t_th=60.*1.e6*P_yr)
...
#     grp.attrs['dlogR2_cut'] = dlogR2_cut
    ...
    grp.attrs['tau_r_Myr'] = tau_r_Myr
    grp.attrs['tau_d_Myr'] = tau_d_Myr
...
#         # full
        ...
        tau_r_Myr = 10.**rng.uniform(0., 2.5)
        tau_r_Myr = precision_round(tau_r_Myr)
        
        # dlogR2_adj = rng.uniform(1, 2)
        # dlogR2_adj = precision_round(dlogR2_adj)
        dlogR2_adj = 1.
